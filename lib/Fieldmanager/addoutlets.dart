...
List addstoretooutlets = store.addoutlet.map((String val) {return new DropdownMenuItem<String>(value: val, child: new Text(val),);}).toList();
                              ...
                              onTap: ()async{
                               if(validateform()){
                                 setState(() {
                                  ...
                                  outlets = outletdata.outletname.map((String val) {return new DropdownMenuItem<String>(value: val, child: new Text(val),);}).toList();
                                 setState(() {

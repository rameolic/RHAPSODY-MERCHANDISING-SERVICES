...
Future Addedstockdataforclient() async{
  ...
  http.Response response = await http.post(Uri.parse("https://rms2.rhapsody.ae/api/client_view_outlet_stock_expirey_details"),
    headers: {
  ...
  if (response.statusCode == 200){
    ...
    for(int u=0;u<decodeoutlet['data'].length;u++) {
      ...
      Stockdata.nearexpiryvalue.add(decodeoutlet['data'][u]['near_expiry_value']);
      Stockdata.estimateexpiryvalue.add(decodeoutlet['data'][u]['extimate_expire_value']);

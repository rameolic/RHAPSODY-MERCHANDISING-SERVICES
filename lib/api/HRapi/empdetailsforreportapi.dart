...
Future getempdetailsforreport() async{
  ...
  if (EmpReport.statusCode == 200){
    ...
    for(int u=0;u<decodeddata['data'].length;u++) {
      ...
      reporting.merchandisersid.add(decodeddata["data"][u]['employee']['employee_id']);
      reporting.fmnames.add('${decodeddata["data"][u]['employee_reporting_to']['surname']} ${decodeddata["data"][u]['employee_reporting_to']['first_name']}');
    }

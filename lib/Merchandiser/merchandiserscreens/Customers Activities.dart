                                              ...
                                              child: new ListView.builder(
                                                  ...
                                                  itemBuilder: (BuildContext context, int index) {
                                                    return GestureDetector(
                                                      onTap: (){
                                                        setState(() {
                                                          CheckList[index] == false ? CheckList[index] = true : CheckList[index] = false;
                                                        });
                                                      },
                                                      child: Column(
                                                        children: [
                                                          Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                            children: [
                                                              Text(task.list[index],style: TextStyle(fontSize: 16),),
                                                              Spacer(),
                                                              Icon(
                                                                CheckList[index] == true ? CupertinoIcons.check_mark_circled_solid :CupertinoIcons.xmark_circle_fill,
                                                                color: CheckList[index] == true ? orange : Colors.grey,size:30 , ),
                                                            ],
                                                          ),
                                                          SizedBox(height: 5,),
                                                        ],
